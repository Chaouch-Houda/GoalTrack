...
const storage = multer.diskStorage({  // Configuration du stockage des fichiers téléchargés
  destination: (req, file, cb) => {  // Définition du dossier de destination des fichiers avec la fonction destination
    cb(null, 'uploads/');           // Dans ce cas, les fichiers seront stockés dans le dossier "uploads/"
  },
