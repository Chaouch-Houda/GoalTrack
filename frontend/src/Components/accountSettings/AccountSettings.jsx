  ...
  return (
    <div className='accountSettings'>
      ...
      <div className={`block-ac` }>
        ...
        <RenderInput name="First name" label="First name" type="text" placeholder= "houda" inputClasses='input-ac' control={control} errors={errors} 
                                rules={{
                                    required: 'This field is required',
                                    maxLength: {
                                        value: 20, // Longueur maximale de 20 caractères
        ...
        />
        <RenderInput name="Last name" label="Last name" type="text" placeholder= "chaouch" inputClasses='input-ac ' control={control} errors={errors} 
                                rules={{
                                    required: 'This field is required',
                                    maxLength: {
                                        value: 20, // Longueur maximale de 20 caractères
      ...
      <div>
        ...
        <div className='block-ac'>
          <Form.Group className='input-ac input-country'>
            ...
            <Select options={countryOptions} className='text-black'/>
          </Form.Group>
